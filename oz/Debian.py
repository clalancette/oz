...
class DebianGuest(oz.Guest.CDGuest):
    ...
    def _modify_iso(self):
        ...
        f.write("  append file=/cdrom/preseed/customiso.seed auto=true debian-installer/locale=en_US console-setup/layoutcode=us netcfg/choose_interface=auto priority=critical initrd=" + installdir + "/initrd.gz --\n")
        f.close()
