...
def guest_factory(tdl, config):
    if tdl.distro == "Fedora":
        return Fedora.get_class(tdl, config)
    elif tdl.distro == "FedoraCore":
        return FedoraCore.get_class(tdl, config)
    elif tdl.distro == "RHEL-2.1":
        return RHEL_2_1.get_class(tdl, config)
    elif tdl.distro == "RHEL-3":
        return RHEL_3.get_class(tdl, config)
    elif tdl.distro == "RHEL-4":
        return RHEL_4.get_class(tdl, config)
    elif tdl.distro == "RHEL-5":
        return RHEL_5.get_class(tdl, config)
    elif tdl.distro == "RHEL-6":
        return RHEL_6.get_class(tdl, config)
    elif tdl.distro == "Ubuntu":
        return Ubuntu.get_class(tdl, config)
    elif tdl.distro == "Windows":
        return Windows.get_class(tdl, config)
    elif tdl.distro == "RHL":
        return RHL.get_class(tdl, config)
    elif tdl.distro == "OpenSUSE":
        return OpenSUSE.get_class(tdl, config)
